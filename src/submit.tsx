...
//     const inputs = [fname.value, lname.value, password.value];
//     console.log(inputs);
...
//         // submit if all values are present and true
//         if(answer) {
//             console.log('submit');
//         }
//     }

    export default function validateForm(e : React.ChangeEvent<HTMLElement>) {
        e.preventDefault();
        const fname : HTMLInputElement | null = document.querySelector<HTMLInputElement>('input[id="first_name"]');
        const lname : HTMLInputElement | null = document.querySelector<HTMLInputElement>('input[id="last_name"]');
        const email : HTMLInputElement | null = document.querySelector<HTMLInputElement>('input[id="email_address"]');
        ...
        const inputs = [fname.value, lname.value, email.value, password.value];
        console.log(inputs);
        }
        let formValid : boolean= false;
