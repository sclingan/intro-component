...
function Form() {
    ...
    return (
      <div className="form">
        <form>
          <label htmlFor='first_name' aria-label="first_name" className="sr-hidden">First Name</label>
          ...
          <label htmlFor='last_name' aria-label="last_name" className="sr-hidden">Last Name</label>
          <div className='input_wrapper'>
          ...
          <label htmlFor='email_address' aria-label="email_address" className="sr-hidden">Email Address</label>
          <div className='input_wrapper'>
